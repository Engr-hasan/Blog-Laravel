        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="{{route('admin.addskill.store')}}" method="POST" enctype="multipart/form-data">
                        	@csrf
                            <div class="row">
                                <div class="col-md-12">
                                    Name of Skill: <input type="text" name="name_of_skill" class="form-control" id="name_of_skill" placeholder="Name of Skill">
                                </div>
                            </div>
                            <table  class="table table-hover table-bordered small-text" id="tb" width="100%">
                                <tr class="tr-header">
                                    <th width="15%" class="text-center">Skill_Name</th>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" name="skill_name[]" id="skill_name" class="form-control" placeholder="Skill Name">
                                    </td>
                                    <td>
                                        <input type="text" name="skill_status[]" id="skill_status" class="form-control" placeholder="Skill Status">
                                    </td>
                                    <td>
                                        <input type="number" name="skill_duration[]" id="skill_duration" class="form-control" placeholder="Skill Duration">
                                    </td>
                                    <td>
                                        <input type="text" name="good_skill[]" id="good_skill" class="form-control" placeholder="Good Skill">
                                    </td>
                                    <td>
                                        <input type="text" name="bad_skill[]" id="bad_skill" class="form-control" placeholder="Bad Skill">
                                    </td>
                                    <td>
