...
@push('css')
    <link href="{{asset('assets/frontend/css/author-profile/styles.css')}}" rel="stylesheet">
    <link href="{{asset('assets/frontend/css/author-profile/responsive.css')}}" rel="stylesheet">
    <style type="text/css">
        .favorite_posts{
            color: green;
        }
                ...
                <div class="col-lg-4 col-md-12 ">
                    ...
                    <div class="single-post info-area ">
                        ...
                        <div class="about-area">
                            ...
                            <p>Author Since: {{ $author->created_at->toDateString() }}</p><br>
                            <p>Author Total Post: {{$author->posts->count()}}</p>
                        </div>
